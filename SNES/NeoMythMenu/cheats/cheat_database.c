...
const cheat_t megaman_x_cheats[] =
{
...
const cheat_t super_castlevania_4_cheats[] =
{
...
const cheat_t super_metroid_cheats[] =
{
...
const cheatDbEntry_t cheatDatabase[] =
{
   ...
   {0xC536, 0x3AC9, super_mario_world_cheats, sizeof(super_mario_world_cheats) / sizeof(cheat_t)},
    // Super Mario World (U) [!]
   {0xA0DA, 0x5F25, super_mario_world_cheats, sizeof(super_mario_world_cheats) / sizeof(cheat_t)},

    // Super Mario World (U) [!]
   {0xA0DA, 0x5F25, contra_3_cheats, sizeof(contra_3_cheats) / sizeof(cheat_t)},
