...
u8 sdLoaderMemSel;
u8 useSdAutoBuffer;
u8 allowLastGameSave;
lastPlayedGame_t lastPlayedGame;
...
{
    "\xff\x03\x01\x07 Shell v 0.65\xff\x02\x01\x03 NEO POWER SNES MYTH CARD (A)\xff\x1a\x04\x05\x22 2013 WWW.NEOFLASH.COM     ",
	...
	"\xff\x06\x02\x07Memory\xff\x17\x03\x03Start\xff\x17\x08\x07: Dump, \xff\x17\x10\x03Y\xff\x17\x11\x07: Go back\xff\x16\x03\x03\x42\xff\x16\x04\x07: Toggle",
};
